...
class EmailNotifier:
    ...
    def _build_email_body(self, alert_stocks, stock_data, analysis_results=None, announcements=None):
        ...
        email_template = (template_dir / 'email_template.html').read_text(encoding='utf-8')
        alert_section_template = (template_dir / 'alert_section.html').read_text(encoding='utf-8')
                ...
                for i, announcement in enumerate(announcement_list[:5]):
                    ...
                    if dividend_details and len(dividend_details) > 0:
                        ...
                        for detail in dividend_details:
                            ...
                            ex_dividend_date = detail.get('ex_dividend_date', '未知')
                    ...
                    if llm_dividend and llm_dividend.get('success', False):
                        ...
                        if dividend_per_share:
                            dividend_info.append(f"总分红: {dividend_per_share:.3f}元/股")
